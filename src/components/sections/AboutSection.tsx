...
import { ExpandableItems } from "@/components/ui/expandable-items";
import { media } from "@/data/media";
import { press } from "@/data/press";
import Image from "next/image";

const videos = media.slice().sort((a, b) => b.id - a.id);
const articles = press.slice().sort((a, b) => b.id - a.id);
          ...
          <div className="max-w-6xl mx-auto space-y-16">
            ...
            <div className="space-y-8">
              ...
              <ExpandableItems
                ...
                fewerLabel="Fewer articles"
                extraOffsetClass="pt-6"
              >
                {(visibleArticles) => (
